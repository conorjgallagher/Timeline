...
{
    class OpportunityCampaignResponsesByRegarding : BaseLinkBuilder, IBuilder
    {
        public OpportunityCampaignResponsesByRegarding(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Opportunity Campaign Responses by Regarding";
            ...
            Target["xrmc_query"] =
                ...
                "            <value>4401</value>" + Environment.NewLine +
