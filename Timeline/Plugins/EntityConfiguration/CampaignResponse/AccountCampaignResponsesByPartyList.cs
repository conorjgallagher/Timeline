...
{
    class AccountCampaignResponsesByPartyList : BaseLinkBuilder, IBuilder
    {
        public AccountCampaignResponsesByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Campaign Responses by Party List";
