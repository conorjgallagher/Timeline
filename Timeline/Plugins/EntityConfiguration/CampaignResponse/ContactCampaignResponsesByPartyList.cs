...
{
    class ContactCampaignResponsesByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactCampaignResponsesByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Campaign Responses by Party List";
