...
{
    public class AccountCampaignResponsesByContacts : BaseLinkBuilder, IBuilder
    {
        public AccountCampaignResponsesByContacts(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Campaign Responses by Contacts";
