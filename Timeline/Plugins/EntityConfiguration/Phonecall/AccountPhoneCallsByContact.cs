...
{
    public class AccountPhoneCallsByContact : BaseLinkBuilder, IBuilder
    {
        public AccountPhoneCallsByContact(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Phone Calls by Contact";
