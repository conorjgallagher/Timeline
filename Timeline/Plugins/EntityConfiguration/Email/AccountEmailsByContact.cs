...
{
    public class AccountEmailsByContact : BaseLinkBuilder, IBuilder
    {
        public AccountEmailsByContact(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Emails by Contact";
