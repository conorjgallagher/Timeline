...
{
    class ContactEmailsByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactEmailsByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Emails by Party List";
