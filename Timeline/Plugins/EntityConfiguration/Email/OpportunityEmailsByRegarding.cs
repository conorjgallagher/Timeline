...
{
    class OpportunityEmailsByRegarding : BaseLinkBuilder, IBuilder
    {
        public OpportunityEmailsByRegarding(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Opportunity Emails by Regarding";
            ...
            Target["xrmc_query"] =
                ...
                "            <value>4202</value>" + Environment.NewLine +
