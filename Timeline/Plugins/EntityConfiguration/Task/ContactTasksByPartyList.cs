...
{
    class ContactTasksByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactTasksByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Tasks by Party List";
