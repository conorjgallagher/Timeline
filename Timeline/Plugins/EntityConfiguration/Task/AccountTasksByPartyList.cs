...
{
    class AccountTasksByPartyList : BaseLinkBuilder, IBuilder
    {
        public AccountTasksByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Tasks by Party List";
