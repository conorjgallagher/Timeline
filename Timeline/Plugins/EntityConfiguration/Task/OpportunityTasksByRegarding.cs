...
{
    class OpportunityTasksByRegarding : BaseLinkBuilder, IBuilder
    {
        public OpportunityTasksByRegarding(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Opportunity Tasks by Regarding";
            ...
            Target["xrmc_query"] =
                ...
                "            <value>4212</value>" + Environment.NewLine +
