...
{
    public class AccountTasksByContact : BaseLinkBuilder, IBuilder
    {
        public AccountTasksByContact(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Tasks by Contact";
