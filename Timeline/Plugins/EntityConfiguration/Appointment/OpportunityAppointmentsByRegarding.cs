...
{
    class OpportunityAppointmentsByRegarding : BaseLinkBuilder, IBuilder
    {
        public OpportunityAppointmentsByRegarding(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Opportunity Appointments by Regarding";
