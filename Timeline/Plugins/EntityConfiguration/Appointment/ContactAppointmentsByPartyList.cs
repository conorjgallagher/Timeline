...
{
    class ContactAppointmentsByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactAppointmentsByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Appointments by Party List";
