...
{
    class AccountAppointmentsByContacts : BaseLinkBuilder, IBuilder
    {
        public AccountAppointmentsByContacts(IOrganizationService service, IBuilder parent) : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Appointments by Contacts";
