...
{
    class AccountAppointmentsByPartyList : BaseLinkBuilder, IBuilder
    {
        public AccountAppointmentsByPartyList(IOrganizationService service, IBuilder parent) : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Appointments by Party List";
            ...
            Target["xrmc_query"] =
                ...
                "            <value>4201</value>" + Environment.NewLine +
