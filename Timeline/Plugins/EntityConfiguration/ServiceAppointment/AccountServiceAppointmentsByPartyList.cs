...
{
    class AccountServiceAppointmentsByPartyList : BaseLinkBuilder, IBuilder
    {
        public AccountServiceAppointmentsByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Service Appointments by Party List";
