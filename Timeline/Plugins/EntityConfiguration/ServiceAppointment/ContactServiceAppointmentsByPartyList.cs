...
{
    class ContactServiceAppointmentsByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactServiceAppointmentsByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Service Appointments by Party List";
