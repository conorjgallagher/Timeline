...
{
    class OpportunityServiceAppointmentsByRegarding : BaseLinkBuilder, IBuilder
    {
        public OpportunityServiceAppointmentsByRegarding(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Opportunity Service Appointments by Regarding";
