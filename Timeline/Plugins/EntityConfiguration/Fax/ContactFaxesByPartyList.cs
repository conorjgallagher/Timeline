...
{
    class ContactFaxesByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactFaxesByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Faxes by Party List";
