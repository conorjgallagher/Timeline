...
{
    class AccountFaxesByPartyList : BaseLinkBuilder, IBuilder
    {
        public AccountFaxesByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Faxes by Party List";
