...
{
    class OpportunityFaxesByRegarding : BaseLinkBuilder, IBuilder
    {
        public OpportunityFaxesByRegarding(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Opportunity Faxes by Regarding";
            ...
            Target["xrmc_query"] =
                ...
                "            <value>4204</value>" + Environment.NewLine +
