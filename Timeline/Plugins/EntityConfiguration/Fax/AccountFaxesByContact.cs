...
{
    public class AccountFaxesByContact : BaseLinkBuilder, IBuilder
    {
        public AccountFaxesByContact(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Faxes by Contact";
