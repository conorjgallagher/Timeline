...
{
    public class AccountCasesByContact : BaseLinkBuilder, IBuilder
    {
        public AccountCasesByContact(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Cases by Contact";
