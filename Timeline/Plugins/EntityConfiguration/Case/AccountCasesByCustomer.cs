...
{
    class AccountCasesByCustomer : BaseLinkBuilder, IBuilder
    {
        public AccountCasesByCustomer(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Cases by Customer";
