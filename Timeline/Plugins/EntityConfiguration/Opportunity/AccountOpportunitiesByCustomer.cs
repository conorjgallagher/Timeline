...
{
    class AccountOpportunitiesByCustomer : BaseLinkBuilder, IBuilder
    {
        public AccountOpportunitiesByCustomer(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Opportunities by Customer";
