...
{
    class ContactLettersByPartyList : BaseLinkBuilder, IBuilder
    {
        public ContactLettersByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Contact Letters by Party List";
