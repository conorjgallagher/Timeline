...
{
    class AccountLettersByPartyList : BaseLinkBuilder, IBuilder
    {
        public AccountLettersByPartyList(IOrganizationService service, IBuilder parent)
            : base(service, parent)
        {
        }
        ...
        public void Construct()
        {
            ...
            const string linkName = "Account Letters by Party List";
